            ...
            <div className="container p-6 mx-auto">
                <div className="lg:flex">
                    <div className="w-full -mx-6 lg:w-2/5">
                        <div className="px-6">
                            <a className='text-[32px] font-bold' href="#">Findr
                            </a>
                            <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400">
                                Join 31,000+ others and never miss out on new tech news and Products.
                            </p>
                    ...
                    <div className="mt-6 lg:mt-0 lg:flex-1">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            ...
                            <div>
                                <h3 className="text-gray-700 uppercase dark:text-white">Know About</h3>
                                <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">App</a>
                                <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Software</a>
                                <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Tech news</a>
                            </div>
                            <div>
                                <h3 className="text-gray-700 uppercase dark:text-white">Contact</h3>
                                <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+1 526 654 8965</span>
                                <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">zihad12@email.com</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <p className="text-center text-gray-500 dark:text-gray-400">© Findr 2024 - All rights reserved</p>
                </div>
            </div>
        </footer>
    );
